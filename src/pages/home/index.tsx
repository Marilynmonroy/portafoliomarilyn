      ...
      <main className={styles.main}>
        <div className={styles.profile}>
          ...
          <div className={styles.personalDescription}>
            ...
            <span>
              Olá! Sou uma profissional de línguas modernas com um forte
              interesse em comunicação e design digital. Minhas habilidades
              estão centradas no processo criativo e na criação de conteúdo para
              plataformas digitais, assim como na construção de identidades
              visuais e no desenvolvimento de branding pessoal.
            </span>
          </div>
